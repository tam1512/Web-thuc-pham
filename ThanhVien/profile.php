...
<article class="card-body mx-auto" style="max-width: 400px;">
  ...
  <div class="form-group input-group">
    ...
    <input name="" class="form-control" placeholder="Phone number" type="text" value="<?php echo$row['DiaChi'] ?>">
  </div> <!-- form-group end.// -->
      </br>
       <p class="text-center">Bạn muốn Đổi mật khẩu? <a href="changePassword.php?id=<?php echo$row['ID_ThanhVien'] ?>">Nhấn vào đây</a> </p>      
      <p class="text-center">Bạn muốn sửa thông tin? <a href="profilefix.php?id=<?php echo$row['ID_ThanhVien'] ?>">Nhấn vào đây</a> </p>                                                               
</form>
</article>
</div>
  <hr class="hr--large">
